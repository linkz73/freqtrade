import{o as a,c as n,a as p}from"./index-1d9d7dc5.js";const l={class:"md-content__inner md-typeset"},o={__name:"StrategyAnalysisExample",setup(c){return(t,s)=>(a(),n("article",l,s[0]||(s[0]=[p(`<h1 id="strategy-analysis-example"> 전략 분석 예제 <a class="headerlink" href="#strategy-analysis-example" title="영구 링크"> ¶ </a></h1><p> 전략을 디버깅하는 것은 시간이 많이 소요될 수 있습니다. Freqtrade는 원시 데이터를 시각화할 수 있는 도우미 함수를 제공합니다. 아래 내용은 SampleStrategy, Binance의 5분 타임프레임 데이터를 사용하며, 데이터를 기본 위치의 데이터 디렉토리에 다운로드했다고 가정합니다. 자세한 내용은 <a href="data-download.html">문서</a> 를 참조하세요. </p><h2 id="setup"> 설정 <a class="headerlink" href="#setup" title="영구 링크"> ¶ </a></h2><h3 id="change-working-directory-to-repository-root"> 작업 디렉토리를 저장소 루트로 변경 <a class="headerlink" href="#change-working-directory-to-repository-root" title="영구 링크"> ¶ </a></h3><div class="highlight"><pre><code><span class="kn">import</span><span class="w"> </span><span class="nn">os</span>
...
<span class="n">fig</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</code></pre></div><p>이 문서를 개선하거나 데이터를 분석하는 최적의 방법에 대한 아이디어를 공유하고 싶다면, 이슈 또는 Pull Request를 제출하세요.</p>`,37)])))}};export{o as default};
