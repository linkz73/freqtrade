import{o as e,c as l,a as n,b as a,u as p}from"./index-1d9d7dc5.js";const t="/assets/plot-dataframe-91df509a.png",o="/assets/plot-dataframe2-c80a36b7.png",c="/assets/plot-profit-1a85ce31.png";const i={class:"md-content__inner md-typeset"},r=["src"],d=["src"],f=["src"],h={__name:"Plotting",setup(u){return(m,s)=>(e(),l("article",i,[s[0]||(s[0]=n('<h1 id="plotting"> 플로팅 <a class="headerlink" href="#plotting" title="영구 링크"> ¶ </a></h1><p>이 페이지는 가격, 지표 및 수익을 플로팅하는 방법을 설명합니다.</p><div class="admonition warning"><p class="admonition-title">사용 중단됨</p><p> 이 페이지에서 설명된 명령( <code> plot-dataframe </code> , <code> plot-profit </code> )은 더 이상 권장되지 않으며 유지 관리 모드에 있습니다. 이는 중간 크기 이상의 플롯에서도 성능 문제가 발생할 수 있기 때문이며, &quot;파일을 저장하고 브라우저에서 여는 방식&quot;이 UI 관점에서 직관적이지 않기 때문입니다. </p><p>즉각적인 제거 계획은 없지만, 적극적으로 유지 관리되지 않으며, 작동을 유지하기 위해 주요 변경이 필요한 경우 단기적으로 제거될 수 있습니다.</p><p> 플로팅 요구 사항에는 동일한 성능 문제를 겪지 않는 <a href="freq-ui.html">FreqUI</a> 를 사용하세요. </p></div><h2 id="installation-setup"> 설치 / 설정 <a class="headerlink" href="#installation-setup" title="영구 링크"> ¶ </a></h2><p>플로팅 모듈은 Plotly 라이브러리를 사용합니다. 다음 명령을 실행하여 설치/업그레이드할 수 있습니다:</p><div class="highlight"><pre><code>pip install -U -r requirements-plot.txt</code></pre></div><h2 id="plot-price-and-indicators"> 가격 및 지표 플로팅 <a class="headerlink" href="#plot-price-and-indicators" title="영구 링크"> ¶ </a></h2><p><code>freqtrade plot-dataframe</code> 하위 명령은 세 개의 서브플롯이 있는 대화형 그래프를 표시합니다:</p><ul><li>캔들스틱 및 가격을 따르는 지표(sma/ema)가 포함된 메인 플롯</li><li>거래량 막대</li><li><code>--indicators2</code>로 지정된 추가 지표</li></ul>',9)),a("p",null,[a("img",{alt:"plot-dataframe",src:p(t)},null,8,r)]),s[1]||(s[1]=n(`<p>사용 가능한 인수:</p><div class="highlight"><pre><code>usage: freqtrade plot-dataframe [-h] [-v] [--no-color] [--logfile FILE] [-V]
