import{r as e,o,c as r,b as n,d as a,e as l,w as c,a as t}from"./index-747ab7f0.js";const d={class:"md-content__inner md-typeset"},i={class:"admonition tip"},_={__name:"ProducerConsumer",setup(m){return(u,s)=>{const p=e("router-link");return o(),r("article",d,[s[9]||(s[9]=n("h1",{id:"producer-consumer-mode"},[a(" 프로듀서 / 컨슈머 모드 "),n("a",{class:"headerlink",href:"#producer-consumer-mode",title:"영구 링크"}," ¶ ")],-1)),s[10]||(s[10]=n("p",null,[a(" freqtrade는 인스턴스(이하 "),n("code",null," 컨슈머 "),a(" )가 메시지 웹소켓을 사용하여 상위 freqtrade 인스턴스(이하 "),n("code",null," 프로듀서 "),a(" )로부터 메시지를 수신할 수 있는 메커니즘을 제공합니다. 주로 "),n("code",null," analyzed_df "),a(" 와 "),n("code",null," whitelist "),a(" 메시지를 수신합니다. 이를 통해 여러 봇에서 페어에 대한 계산된 지표(및 신호)를 여러 번 계산할 필요 없이 재사용할 수 있습니다. ")],-1)),n("p",null,[s[1]||(s[1]=a(" 메시지 웹소켓 설정에 대한 자세한 내용은 Rest API 문서의 ")),l(p,{to:"rest-api"},{default:c(()=>s[0]||(s[0]=[a(" 메시지 웹소켓 ")])),_:1}),s[2]||(s[2]=a(" 섹션을 참조하세요. 이 설정은 프로듀서의 ")),s[3]||(s[3]=n("code",null," api_server ",-1)),s[4]||(s[4]=a(" 구성을 포함합니다. "))]),s[11]||(s[11]=t(`<div class="admonition note"><p class="admonition-title">참고</p><p><code> ws_token </code> 을 무작위로 설정하고 본인만 알 수 있도록 설정하여 봇에 대한 무단 접근을 방지하는 것을 강력히 권장합니다. </p></div><h2 id="configuration"> 구성 <a class="headerlink" href="#configuration" title="영구 링크"> ¶ </a></h2><p><code> external_message_consumer </code> 섹션을 컨슈머의 설정 파일에 추가하여 인스턴스 구독을 활성화하세요. </p><div class="highlight"><pre><code><span class="p">{</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
        ...
        <span class="k">return</span> <span class="n">dataframe</span>
</code></pre></div><div class="admonition tip"><p class="admonition-title">상위 신호 사용</p><p><code> remove_entry_exit_signals=false </code> 로 설정하면 프로듀서의 신호를 직접 사용할 수도 있습니다. 이 신호는 <code> enter_long_default </code> (가정 <code> suffix=&quot;default&quot; </code> 가 사용됨)로 사용할 수 있으며, 직접 신호로 사용하거나 추가 지표로 사용할 수 있습니다. </p></div>`,4))])}}};export{_ as default};
