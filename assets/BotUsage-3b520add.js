...
</code></pre></div><p>이 방법은 로컬 머신에서 적절한 파일 권한을 설정하여 실제 비밀을 포함한 파일을 숨기고, 프로젝트 문제나 인터넷에 구성 예제를 게시할 때 민감한 개인 데이터의 의도하지 않은 공개를 방지하는 데 도움이 될 수 있습니다.</p>`,19)),r("p",null,[e[1]||(e[1]=t("이 기술에 대한 자세한 내용과 예제는 ")),o(s,{to:"configuration"},{default:n(()=>e[0]||(e[0]=[t("구성")])),_:1}),e[2]||(e[2]=t(" 문서 페이지를 참조하세요."))]),e[10]||(e[10]=a(`<h3 id="where-to-store-custom-data"> 사용자 정의 데이터를 저장할 위치 <a class="headerlink" href="#where-to-store-custom-data" title="영구 링크"> ¶ </a></h3><p>Freqtrade는 <code>freqtrade create-userdir --userdir someDirectory</code> 명령을 사용하여 사용자 데이터 디렉토리를 생성할 수 있습니다. 이 디렉토리는 다음과 같이 보입니다:</p><div class="highlight"><pre><code>user_data/
├── backtest_results
├── data
├── hyperopts
├── hyperopt_results
...
</code></pre></div><p>봇이 전략 파일을 찾지 못하면 파일을 찾을 수 없는 이유 (파일을 찾을 수 없음 또는 코드 오류)를 오류 메시지로 표시합니다.</p>`,13)),r("p",null,[e[4]||(e[4]=t("전략 파일에 대한 자세한 내용은 ")),o(s,{to:"strategy-customization"},{default:n(()=>e[3]||(e[3]=[t("전략 사용자 정의")])),_:1}),e[5]||(e[5]=t("를 참조하세요."))]),e[11]||(e[11]=a(`<h3 id="how-to-use-strategy-path"><strong>--strategy-path</strong>를 사용하는 방법 <a class="headerlink" href="#how-to-use-strategy-path" title="영구 링크"> ¶ </a></h3><p>이 매개변수는 추가 전략 검색 경로를 추가할 수 있게 해주며, 기본 위치보다 먼저 확인됩니다 (전달된 경로는 디렉토리여야 합니다!):</p><div class="highlight"><pre><code>freqtrade trade --strategy AwesomeStrategy --strategy-path /some/directory
...
</code></pre></div><h2 id="next-step"> 다음 단계 <a class="headerlink" href="#next-step" title="영구 링크"> ¶ </a></h2>`,9)),r("p",null,[e[7]||(e[7]=t("봇의 최적 전략은 시장 동향에 따라 시간이 지남에 따라 변경됩니다. 다음 단계는 ")),o(s,{to:"strategy-customization"},{default:n(()=>e[6]||(e[6]=[t("전략 사용자 정의")])),_:1}),e[8]||(e[8]=t("입니다."))])])}}};export{u as default};
