import{f as c}from"./frequi_url-aafab580.js";import{r as d,o as l,c as r,b as n,d as a,e,w as o,a as t,u as i}from"./index-f254d819.js";const u={class:"md-content__inner md-typeset"},g=["src"],f={__name:"RestAPI",setup(h){return(m,s)=>{const p=d("router-link");return l(),r("article",u,[s[9]||(s[9]=n("h1",{id:"rest-api"},[a(" REST API "),n("a",{class:"headerlink",href:"#rest-api",title:"영구 링크"}," ¶ ")],-1)),s[10]||(s[10]=n("h2",{id:"frequi"},[a(" FreqUI "),n("a",{class:"headerlink",href:"#frequi",title:"영구 링크"}," ¶ ")],-1)),n("p",null,[s[1]||(s[1]=a(" FreqUI는 이제 전용 ")),e(p,{to:"freq-ui"},{default:o(()=>s[0]||(s[0]=[a(" 문서 섹션 ")])),_:1}),s[2]||(s[2]=a(" 을(를) 가지고 있습니다. FreqUI에 대한 모든 정보는 해당 섹션을 참조하세요. "))]),s[11]||(s[11]=t(`<h2 id="configuration"> 설정 <a class="headerlink" href="#configuration" title="영구 링크"> ¶ </a></h2><p>REST API를 활성화하려면 설정 파일에 <code>api_server</code> 섹션을 추가하고 <code>api_server.enabled</code>를 <code>true</code>로 설정하세요.</p><p>샘플 설정:</p><div class="highlight"><pre><code><span class="w">    </span><span class="nt">&quot;api_server&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
...
</code></pre></div>`,35)),n("p",null,[s[6]||(s[6]=a(" 다음과 같은 경우, FreqUI는 ")),s[7]||(s[7]=n("code",null,"http://localhost:8080/trade",-1)),s[8]||(s[8]=a("에서 접근 가능합니다. ")),n("img",{alt:"freqUI url",src:i(c)},null,8,g)]),s[13]||(s[13]=t(`<p>이 경우 올바른 설정은 <code>http://localhost:8080</code>입니다.</p><div class="highlight"><pre><code>{
    //...
    &quot;jwt_secret_key&quot;: &quot;somethingrandom&quot;,
    &quot;CORS_origins&quot;: [&quot;http://localhost:8080&quot;],
    //...
}
</code></pre></div><div class="admonition tip"><p class="admonition-title">슬래시</p><p>&gt;CORS_origins&lt; 구성에서 슬래시는 허용되지 않습니다(예: <code>&quot;http://localhots:8080/&quot;</code>). 이러한 구성은 효과가 없으며 CORS 오류가 계속 발생합니다.</p></div><div class="admonition note"><p class="admonition-title">참고</p><p>봇에 대한 무단 액세스를 방지하기 위해 <code>jwt_secret_key</code>를 무작위 값으로 설정하는 것을 강력히 권장합니다.</p></div>`,4))])}}};export{f as default};
