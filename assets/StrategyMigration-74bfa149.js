...
<span class="hll">        <span class="s2">&quot;entry&quot;</span><span class="p">:</span> <span class="mi">10</span><span class="p">,</span>
        ...
        <span class="s2">&quot;unit&quot;</span><span class="p">:</span> <span class="s2">&quot;minutes&quot;</span>
    <span class="p">}</span>
</code></pre></div><h4 id="order-pricing"><code> 주문 가격 책정 </code><a class="headerlink" href="#order-pricing" title="영구 링크"> ¶ </a></h4><p> 주문 가격 책정은 두 가지 방식으로 변경되었습니다. <code> bid_strategy </code> 는 <code> entry_pricing </code> 으로 이름이 변경되었고, <code> ask_strategy </code> 는 <code> exit_pricing </code> 으로 이름이 변경되었습니다. 속성 <code> ask_last_balance </code> -&gt; <code> price_last_balance </code> 및 <code> bid_last_balance </code> -&gt; <code> price_last_balance </code> 도 이름이 변경되었습니다. 또한 가격 측면은 이제 <code> ask </code> , <code> bid </code> , <code> same </code> 또는 <code> other </code> 로 정의될 수 있습니다. 자세한 내용은 <a href="configuration.html"> 가격 책정 문서 </a> 를 참조하세요. </p><div class="highlight"><pre><code><span class="p">{</span>
