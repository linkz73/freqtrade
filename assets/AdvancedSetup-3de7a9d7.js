...
</code></pre></div><p> SQLite 데이터베이스 사용에 대한 자세한 내용은 예를 들어 거래를 수동으로 입력하거나 제거하는 방법에 대해서는 <a href="sql_cheatsheet.html"> SQL Cheatsheet </a> 를 참조하세요. </p><h3 id="multiple-instances-using-docker"> Docker를 사용한 여러 인스턴스 <a class="headerlink" href="#multiple-instances-using-docker" title="영구 링크"> ¶ </a></h3><p>Docker를 사용하여 freqtrade의 여러 인스턴스를 실행하려면 docker-compose.yml 파일을 편집하고 원하는 모든 인스턴스를 별도의 서비스로 추가해야 합니다. 구성 파일을 여러 개로 분리할 수 있으므로 모듈화하는 것이 좋습니다. 이렇게 하면 모든 봇에 공통적인 내용을 편집해야 할 때 단일 구성 파일에서 편집할 수 있습니다.</p><div class="highlight"><pre><code>---
version: &#39;3&#39;
services:
  freqtrade1:
